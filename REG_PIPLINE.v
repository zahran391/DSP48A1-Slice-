...
// فكره الموديول الي بعده اني لو لاحظت في رسمه الهاردوير الموجوده في المشروع نجد انه مبني على الريجيسرترات وخطوط التوصيل ف هوصف على طول في التوب موديول 
// وفي كل مره هاجي عندي اي ريجيستر في الرسمه هنشوف الاوت بتاعه نكتب جنبه وير بلس هنستعدي موديول الريجيسترات بتاعنا ونشوف العمليه ايه 
// Operation ---> Pre_add_Sub ||  Multi ||  Post_add_sub 
